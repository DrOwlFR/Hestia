			...
			embeds: [
				client.functions.embed()
					...
					.addFields([
						...
						{ name: `${config.emojis.developer} Développeur`, value: `${interaction.guild?.members.cache.get(client.admins[0])}` },
						{ name: `${config.emojis.highConnection} En ligne depuis`, value: `<t:${readyTimestamp}:F>, <t:${readyTimestamp}:R>` },
						{ name: `${config.emojis.line}${config.emojis.line}${config.emojis.line}${config.emojis.line}${config.emojis.line}${config.emojis.line}`, value: " " },
						{ name: `${config.emojis.bot} Bot`, value: `\` v${version} \``, inline: true },
						{ name: `${config.emojis.nodejs} NodeJs`, value: "` v22.18.0 `", inline: true },
						{ name: `${config.emojis.discordjs} Discord.Js`, value: `\` v${dependencies["discord.js"].substring(1)} \``, inline: true },
						{ name: `${config.emojis.sheweny} Framework`, value: `\` Sheweny v${dependencies["sheweny"].substring(1)} \``, inline: true },
					]),
			],
			components: [
